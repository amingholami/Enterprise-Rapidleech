...
'users' => array('admin' => 'pass123'), # false - Authorization mode is off, enter the username and password in the given way
'login_cgi' => false, # true - Will try to workaround CGI authorization
//Presentation
'template_used' => 'Enterprise_by_AminGholami.com',
'default_language' => 'en',
'show_all' => true, # true - To show all files in the catalog, false to hide them
...
'site_title' => 'Rapidleech Premium',
'site_title_description' => 'easy transload your files from fileshare servers, and do them direct...',

# white, Blue, Green, Yellow, Orange, Red.
'default_color' => 'white',
'color_schem_box' => true,
