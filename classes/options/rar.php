...
function rar() {
  ...
  if (!is_file(ROOT_DIR.'/rar/rar')) { echo '<div class="neveshte_inner_error" title="Click to Hide!" align="center"><strong>'.lang(343).'</strong></div>'; }
  else {
?>
<div align="left"><strong>Adding files to a RAR archive</strong></div>
...
?>
                  <option value="0"><?php echo lang(349); ?></option>
                  <option value="0"><?php echo lang(350); ?></option>
                  <option value="0"><?php echo lang(351); ?></option>
                  <option value="0"><?php echo lang(352); ?></option>
                  <option value="0"><?php echo lang(353); ?></option>
<?php
      }
?>
                </select></label>
              ...
              <td class="rar-options-right-td">
                <label><input type="checkbox" name="rar_opts[vols]" value="1" onclick="javascript:var displ=this.checked?'inline':'none';document.getElementById('rar_opts_vols').style.display=displ;var fc=document.getElementsByName('rar_opts[vols_s]')[0]; fc.focus(); fc.selectionStart = 0; fc.selectionEnd = fc.value.length;" /> <?php echo lang(354); ?></label>
            ...
            <tr>
              <td class="rar-options-left-td">
                <label><input type="checkbox" name="rar_opts[delete]" value="1"<?php echo ($options['disable_deleting'] ? ' disabled="disabled"' : '');?> /> <?php echo lang(355); ?></label>
              </td>
              <td class="rar-options-right-td">
                <label><input type="checkbox" name="rar_opts[solid]" value="1" /> <?php echo lang(356); ?></label>
              </td>
            </tr>
            <tr>
              <td class="rar-options-left-td">
                <label><input type="checkbox" name="rar_opts[rec_rec]" value="1" onclick="javascript:var displ=this.checked?'inline':'none';document.getElementById('rar_opts_rec_rec').style.display=displ; var fc=document.getElementsByName('rar_opts[rec_rec_s]')[0]; fc.focus(); fc.selectionStart = 0; fc.selectionEnd = fc.value.length;" /> <?php echo lang(357); ?></label>
                <span id="rar_opts_rec_rec" style="display:none">
                  <br />From 1 to 10: <input type="text" size="3" name="rar_opts[rec_rec_s]" value="1" />%
                </span>
              </td>
              <td class="rar-options-right-td">
               <label> <input type="checkbox" name="rar_opts[test]" value="1" /> <?php echo lang(358); ?></label>
              </td>
            </tr>
            <tr>
              <td class="rar-options-left-td">
                <label><input type="checkbox" name="rar_opts[use_pass1]" value="1" onclick="javascript:var displ=this.checked?'inline':'none';document.getElementById('rar_opts_pass').style.display=displ;document.getElementsByName('rar_opts[pass]')[0].focus();" /> <?php echo lang(359); ?></label>
              ...
              <td class="rar-options-right-td">
                <label><input type="checkbox" name="rar_opts[path_i]" value="1" onclick="javascript:var displ=this.checked?'inline':'none';document.getElementById('rar_opts_path_i').style.display=displ;document.getElementsByName('rar_opts[path_i_path]')[0].focus();" /> <?php echo lang(361); ?></label>
                <span id="rar_opts_path_i" style="display:none;"><br /><input type="text" size="15" name="rar_opts[path_i_path]" value="" /></span>
              </td>
            </tr>
            <tr>
              <td class="rar-options-left-td">
                <label><input type="checkbox" name="rar_opts[separated]" value="1" /> <?php echo lang(387); ?></label>
              </td>
              <td class="rar-options-right-td">&nbsp;
      ...
      <tr>
        <td align="center">
          ...
          <input style="width:auto" type="submit" value="<?php echo lang(362); ?>" />
        </td>
      </tr>
      <tr>
        <td>&nbsp;</td>
